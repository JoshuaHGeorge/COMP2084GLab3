...
namespace COMP2084GMidTermF2019.Controllers
{
    ...
    public class ElectionsController : Controller
    {
        ...
        {
            ViewData["PartyId"] = new SelectList(_context.Party.OrderBy(Party => Party.Name), "PartyId", "Name");
            return View();
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["PartyId"] = new SelectList(_context.Party.OrderBy(Party => Party.Name), "PartyId", "Name", election.PartyId);
            return View(election);
        }
